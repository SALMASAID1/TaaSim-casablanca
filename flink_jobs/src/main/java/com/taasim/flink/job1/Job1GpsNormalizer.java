...
public class Job1GpsNormalizer {
    ...
    private static final String DEFAULT_CHECKPOINT_DIR = "s3a://taasim/flink-checkpoints/job1/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Task02: checkpointing + RocksDB + MinIO (S3A)
        ...
        // Task02: 3-minute bounded out-of-orderness watermark strategy
        ...
        final DataStream<ZoneDefinition> zoneStream = env.fromCollection(zones).name("zone-mapping");
        ...
        // Sink 1: Cassandra (vehicle_positions)
